...
|---|---|---|---|---|---|
| 2026-08-05 | **iPhone 14**, Safari, 844x390 @ DPR 2 | `Apple GPU` (A15) | v1 | **>= 200** | Estagio A atende. Ver `decisions/0011` |
...
O iPhone 14 usa o A15, o mesmo chip do 13. Nao e aparelho de ponta nem antigo:
serve bem de piso razoavel. Um iPhone mais velho pode nao ter a mesma folga, e
isso so se sabe medindo.
